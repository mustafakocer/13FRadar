...
// - topBought / topSold: approximate traded value, from share-count changes
//   valued at the current implied price (avoids counting pure price moves)
// - newPositions: first-time positions this quarter, per manager
