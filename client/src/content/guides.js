  ...
  '13f-limitations': {
    en: {
      ...
      sections: [
        ...
        { h2: 'Can filings be wrong or changed?', p: ['Yes. Managers file amendments (13F-HR/A) that restate a quarter, occasionally weeks later. Some request confidential treatment and disclose positions only after the SEC decision. Fundocap folds each amendment into the quarter it corrects: a RESTATEMENT replaces the original table, a NEW HOLDINGS amendment adds the positions the original left out. An amendment is never shown as a quarter of its own, and the quarter is marked as amended.'] },
