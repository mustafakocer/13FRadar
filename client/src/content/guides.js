...
export const GUIDE_CONTENT = {
  'what-is-13f': {
    en: {
      ...
      sections: [
        ...
        { h2: 'How do investors use 13F data?', p: ['Three common uses: following the portfolio changes of investors with long track records, measuring consensus (how many managers hold a stock and whether they are adding or reducing), and screening for concentrated managers whose top positions carry real conviction. Fundocap turns each into a page: guru pages, rankings and the emerging managers screen.'] },
      ],
      faq: [
        ['Is 13F data free?', 'Yes. Filings are public on SEC EDGAR. Fundocap parses them and shows the top positions, rankings and insider signals without an account; full tables and exports are part of the Pro plan.'],
  ...
  'how-to-read-form-4': {
    en: {
      ...
      faq: [
        ['Where do Form 4 filings come from?', 'From SEC EDGAR. Fundocap rebuilds its insider dataset daily from the SEC\'s Form 4 feed and keeps one year of buys.'],
  ...
  '13f-limitations': {
    en: {
      ...
      sections: [
        ...
        { h2: 'Why do share counts jump?', p: ['Stock splits change share counts without any trade. Fundocap adjusts historical share counts with a splits table where it has split data and labels those tables split-adjusted; where it does not, a 4-for-1 split looks like a 300% increase. Mergers, spin-offs and ticker changes cause similar breaks.'] },
        { h2: 'Can filings be wrong or changed?', p: ['Yes. Managers file amendments (13F-HR/A) that restate a quarter, occasionally weeks later. Some request confidential treatment and disclose positions only after the SEC decision. Fundocap keeps the most recently filed document for each quarter, so an amendment replaces the original.'] },
    ...
    tr: {
      ...
      sections: [
        ...
        { h2: 'Bildirimler hatalı olabilir veya değişebilir mi?', p: ['Evet. Yöneticiler bir çeyreği yeniden beyan eden düzeltme bildirimleri (13F-HR/A) verir; bazen haftalar sonra. Bazıları gizlilik talep eder ve pozisyonları ancak SEC kararından sonra açıklar. Fundocap her çeyrek için en son verilen belgeyi tutar; düzeltme orijinalin yerini alır.'] },
